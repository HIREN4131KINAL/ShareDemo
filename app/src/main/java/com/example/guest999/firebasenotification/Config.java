...
public class Config {
	...
	public static final String FORGOT_URL = "http://laxmisecurity.com/android/firebase/forget_pass.php";
	public static final String CONFIRM_FORGOT_URL = "http://laxmisecurity.com/android/firebase/confirm_forget.php";
	public static final String FORGOT_PASS_UPDATE = "http://laxmisecurity.com/android/firebase/forget_update_pass.php";
	...
	public static final String KEY_FORGOT = "new_pass";
	...
	public static final String LOGOUT = "http://laxmisecurity.com/android/firebase/update_id.php";
	public static final String DELETE_DATA = "http://laxmisecurity.com/android/firebase/admin_del.php";

	public static final String DELETE_DATA_User = "http://laxmisecurity.com/android/firebase/user_del.php";
	public static final String ad_id = "ad_id";
	public static final String ClearScreenData = "http://laxmisecurity.com/android/firebase/admin_del_all.php";
