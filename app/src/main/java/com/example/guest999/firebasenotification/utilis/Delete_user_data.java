...
public class Delete_user_data {
	...
	public Delete_user_data(Context context, String adid, SwipyRefreshLayout swipeRefreshLayout) {
	...
	private void DeleteUserData() {
		...
		StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.DELETE_DATA_User,
